...
export @Fixture('loanApprovalPage') class LoanApprovalPage {
    ...
    @Then('the interest rate should be calculated based on the {string} program')
    async verifyInterestRateValidPercentage(loanProgram: string) {

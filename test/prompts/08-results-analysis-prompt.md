...
Use the Generative AI to analyze results from the tests, plus any application or client logs to summarize and look for anomalies.

* **Discipline:** Results Analysis
* **Goals:**
  * Define Metrics
  * Summarize Results

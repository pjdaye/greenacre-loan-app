        ...
        return (
            <div name="approvalPanel" className="container" style={{ "fontFamily": 'Segoe UI' }}>
                ...
                <div className="row my-3">
                    ...
                    <div className={`col-sm-4 fs-4 ${styles.textMoneyGreen} fw-bold`}>APPROVED!</div>
                </div>
                <div className="row my-3">
                    <div className="col-sm-6 fs-4 fw-semibold">Your Interest Rate Is:</div>
                    <div className={`col-sm-4 fs-4 ${styles.textMoneyGreen} fw-bold`}>{props.data.rate}%</div>
                </div>
                <div className="row my-3">
                    <div className="col-sm-6 fs-4 fw-semibold">Your Loan Program Is:</div>
                    <div className={`col-sm-4 fs-4 ${styles.textMoneyGreen} fw-bold`}>{loanProgram}</div>
                </div>
            </div>
        ...
        return (
            <div name="approvalPanel" className="container" style={{ "fontFamily": 'Segoe UI' }}>
                ...
                <div className="approvalData row">
                    ...
                    <div className={`col-4 fs-4 ${styles.textCancelRed} fw-bold`}>DENIED</div>
                </div>
            </div>
        )
    }
